...
const aliasesPath = path_1.default.join(process.cwd(), 'config/category-aliases.json');
const rulesPath = path_1.default.join(process.cwd(), 'config/rejection-rules.json');
const CATEGORY_ALIASES = JSON.parse(fs_1.default.readFileSync(aliasesPath, 'utf8'));
const REJECTION_RULES = JSON.parse(fs_1.default.readFileSync(rulesPath, 'utf8'));
 ...
 */
function classifyProduct(name, rawCategory = '', description = '', specifications = {}) {
