...
exports.enrichProductAI = enrichProductAI;
function enrichProductAI(productName, description, brand, category, styles, colors, materials, rooms) {
    ...
    const keywords = Array.from(new Set(rawWords.filter((w) => w.length > 2 && !stopWords.has(w)))).slice(0, 15);
